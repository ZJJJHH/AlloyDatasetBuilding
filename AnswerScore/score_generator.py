...
class ScoreGenerator:
    ...
    def calculate_total_score(self, scores: Dict[str, Dict[str, str]]) -> Dict[str, str]:
        ...
        for answer_key, answer_scores in scores.items():
            ...
            for dimension, score_str in answer_scores.items():
                # 跳过 '总分' 维度和包含下划线的维度（如 _reason）
                if dimension == '总分' or '_' in dimension or '/' not in score_str:
                    continue
    ...
    def generate_optimize_prompt(self, question: Dict[str, Any], question_type: str, 
                                 score_details: Dict[str, Dict[str, str]]) -> str:
        """生成优化提示词"""
        template = OPTIMIZE_PROMPT_TEMPLATE
    ...
    def optimize_answer(self, question: Dict[str, Any], question_type: str,
        ...
        """优化答案"""
        try:
            prompt = self.generate_optimize_prompt(question, question_type, score_details)
    ...
    def add_scores_to_question(self, question: Dict[str, Any], 
        ...
        for answer_key, score_data in score_details.items():
            ...
            if original_key in question:
                ...
                question[original_key]['score'] = score_entry
