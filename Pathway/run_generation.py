...
import sys
import time
from generate_pathway_questions import PathwayQuestionGenerator, save_questions_to_json
...
def main():
    """主函数"""
    parser = argparse.ArgumentParser(description="机制问问题生成器")
    ...
    if not args.no_progress:
        progress_bar = create_progress_bar(target_count, "机制问生成进度")
